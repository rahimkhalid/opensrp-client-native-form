...
public class MaterialSpinner extends AppCompatSpinner implements ValueAnimator.AnimatorUpdateListener {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (error != null && enableErrorLabel) {
            int errorLeftMargin = (int) context.getResources().getDimension(R.dimen.spinner_error_left_margin);
            ...
            if (multiline) {
                ...
                //scrolling
                canvas.drawText(error.toString(), startX + errorLeftMargin + rightLeftSpinnerPadding - errorLabelPosX, startYErrorLabel, textPaint);
                if (errorLabelPosX > 0) {
                    canvas.save();
